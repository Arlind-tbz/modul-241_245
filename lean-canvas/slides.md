...
colorSchema: light
fonts:
  sans: '"Space Grotesk", "Helvetica Neue", ui-sans-serif, system-ui, -apple-system, sans-serif'
info: |
  ## Parkplatz Sharing Zürich
  Lean Canvas für das Modul 241/245.
drawings:
  persist: false
transition: slide-up
title: Parkplatz Sharing Zürich – Lean Canvas
mdc: true
---
...
<div class="h-full flex flex-col justify-center items-start text-left pl-16">
  ...
  <h1 class="text-7xl md:text-8xl font-black leading-[0.9] mb-6">
    ParkAI <br/>
    <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-500">Zürich</span> <br/>
    Canvas.
  </h1>

  <div class="mt-8 text-2xl font-bold text-gray-700 border-l-8 border-black pl-6 py-2">
    Vom Problem zur skalierbaren Lösung.
  </div>
</div>

<!--
Willkommen zum Lean Canvas für ParkAI – eine strukturierte Übersicht über unser Geschäftsmodell.
-->
...
---
src: ./pages/02-customer-segments.md
---
