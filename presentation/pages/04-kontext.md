...
<div>
<h1 class="text-4xl font-black mb-1">Bestehende Alternativen</h1>
<p class="text-xl font-bold text-gray-500">Warum existierende Lösungen scheitern</p>
</div>
<div class="text-5xl opacity-10">📉</div>
</div>

<div class="bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden mb-4">
...
<div class="bg-blue-600 text-white p-4 border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] max-w-xl transform rotate-1 hover:rotate-0 transition-transform">
<h3 class="font-black text-xl mb-1 uppercase tracking-wide">Die Marktlücke</h3>
<p class="text-base font-bold leading-relaxed">Keine aktuelle Lösung verbindet private Anbieter <span class="bg-white text-blue-600 px-2">direkt</span>, sicher und in Echtzeit mit Suchenden.</p>
</div>
</div>
</v-click>
</div>
